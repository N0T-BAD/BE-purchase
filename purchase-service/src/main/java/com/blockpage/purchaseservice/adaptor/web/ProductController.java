...
public class ProductController {
    ...
    public ResponseEntity<ApiWrapperResponse> getAllProducts(@RequestParam String type) {
        ...
        ProductsDetailView productsDetailView = null;

        switch (type) {
            case "nft": {
                productsDetailView = new ProductsDetailView(1L, 1L, "NFT이름", "조석 작가님의 작품을 1BLOCK할인 받을 수 있습니다.", 1000,
            ...
            break;
            case "profile-skin": {
                productsDetailView = new ProductsDetailView(1L, "플레티넘 테두리", "한달 동안 출석체크를 하면 받을 수 있습니다.", 200,
                    "https://i.namu.wiki/i/xWl9taYDaPvw2szKR9xbwBRYmVS8C7yvb4sn0jEKhaadR7OcKt_Voaz7gLEWlXq2Ji_s-T2WDjhMKs2uVSOM2drDi7tFTo0kkH7k-xwHrrKYT02zurwVXCYfVbyzePYOgdEpExfdPGS0PJFYEciiRA.webp");

            }
            break;
            case "episode-bm": {
                productsDetailView = new ProductsDetailView(1L, 1L, 1L, 2, WebtoonBMStatus.ON_SALE);
            }
        }
        return ResponseEntity.status(HttpStatus.OK)
            .body(new ApiWrapperResponse(productsDetailView));
    }
}

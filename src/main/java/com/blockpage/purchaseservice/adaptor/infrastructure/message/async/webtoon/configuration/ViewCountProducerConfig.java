...
@Configuration
public class ViewCountProducerConfig {

    @Value("${spring.kafka.bootstrapAddress}")
    private String bootStrapServer;

    @Bean
    public ProducerFactory<String, ViewCountMessage> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, ViewCountMessage> KafkaTemplate() {

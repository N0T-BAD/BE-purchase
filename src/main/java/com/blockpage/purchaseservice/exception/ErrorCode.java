...
public enum ErrorCode {
    ...
    ALREADY_EXISTENCE_PROFILESKIN("프로필스킨이 이미 존재합니다.", HttpStatus.CONFLICT),
    ...
    MEMBER_SERVICE_SERVER_UNAVAILABLE("멤버 서비스가 이용이 불가능합니다.", HttpStatus.NO_CONTENT),         //오류 메세지 검토 필요
    MEMBER_SERVICE_CLIENT_BAD_REQUEST("멤버 서비스에 잘못된 요청을 보냈습니다.", HttpStatus.NO_CONTENT),     //오류 메세지 검토 필요
